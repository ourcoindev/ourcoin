...
unsigned int nStakeMaxAge = 60* 60 * 24 * 30;	// stake age of coin age: 30d
unsigned int nStakeTargetSpacing = 30;			// 30 sec block spacing

int64 nChainStartTime = 1399540940;
...
const string strMessageMagic = "ourcoin Signed Message:\n";
...
static const int CUTOFF_HEIGHT = POW_CUTOFF_HEIGHT;	// Height at the end of 1 weeks
// miner's coin base reward based on nBits
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
    int64 nSubsidy = 600 * COIN;
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in ourcoin
    bool fStrictPayToScriptHash = true; // Always active in ourcoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "ourcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
      if (!fAllowNew)
        ...
        // Genesis block
        const char* pszTimestamp = "Join ourcoin,our profit 26/April/2014";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("13d149fc0ceca1fd2413294fbbfaeea91ee1dda10250fd51c0ef49e040f3c6ef"));
...
unsigned char pchMessageStart[4] = { 0xfe, 0xdc, 0xef, 0xcd };
